...
void setup() {
 ...
 if (!oneWire.search(outsideThermometer)) lcd.setCursor(0,1); lcd.print("Eo");
 if (!oneWire.search(_insideThermometer)) lcd.setCursor(3,1); lcd.print("Ei");
 ...
 // put Information to Serial 
 Serial.print("Sensors:");
 sensCount=sensors.getDeviceCount();
 Serial.print(sensCount,DEC);
 Serial.println("");
 //loseSomeTime(5000);
 sensors.requestTemperatures();
 temp1=sensors.getTempC(outsideThermometer);
